...
ActiveRecord::Schema[7.2].define(version: 20_241_020_034_122) do
  ...
  create_table 'catch_quota_allocations', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[owner_type owner_id], name: 'index_catch_quota_allocations_on_owner'
  ...
  create_table 'catch_quotas', force: :cascade do |t|
    ...
    t.index %w[owner_type owner_id], name: 'index_catch_quotas_on_owner'
